...
supermarkets <- st_read("plan372_hmks/hw3/hw3-data/triangle_supermarkets_osm.shp")
streets <- st_read("plan372_hmks/hw3/hw3-data/triangle_highways_osm.shp")
blocks <- st_read("plan372_hmks/hw3/hw3-data/orange_durham_wake_block_groups.shp")
census <- read_csv("plan372_hmks/hw3/hw3-data/triangle_census.csv")
